...
FastAPI wrapper for GPT Researcher with file upload support and Docker deployment.

## Features

- 📤 File upload support for research context
...
FAST_LLM=<provider>:<model name> # openai:gpt-4o
SMART_LLM=<provider>:<model name>
STRATEGIC_LLM=<provider>:<model name>
EMBEDDING=<provider>:<model name>
```
